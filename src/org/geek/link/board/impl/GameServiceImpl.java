...
public class GameServiceImpl implements GameService{
	...
	private Point getCornerPoint(Point point1,Point point2,int pieceWidth,int pieceHeight){
		...
		List<Point> point2DownChanel = getDownChanel(point2, point1.y, pieceWidth);
		List<Point> point2LeftChanel = getLeftChanel(point2, point1.x, pieceHeight);
	...
	private Map<Point, Point> getLinkPoints(Point point1,Point point2,int pieceWidth,int pieceHeight){
		...
		List<Point> p2DownChanel = getDownChanel(point2, point1.y, pieceWidth);
		List<Point> p2LeftChanel = getLeftChanel(point2, point1.x, pieceHeight);
